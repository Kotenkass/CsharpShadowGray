    ...
    public partial class Form1 : Form
    {
...

        {
            if (pictureBox1.Image != null) 
               // если изображение в pictureBox1 имеется
            {
        ...
        private void SafeImageToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (pictureBox2.Image != null) 
                // если изображение в pictureBox2 имеется
            {
        ...
        private void AboitOfProgrammToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MessageBox.Show ("Данаая программа бла бла бла");
        }

        private void OfDeveloperToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            MessageBox.Show ("Студент ГАПОУ ЕТ Автоматики Николаев Антон Андреевич");
        }
    }
